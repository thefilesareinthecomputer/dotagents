...
- **`resources/link-ledger.md`** - the alphabetized, deduplicated record of **every URL** already folded in. **Always grep this before adding a new link** - if it's here, it's already covered. Prevents re-discovering the same resource.
